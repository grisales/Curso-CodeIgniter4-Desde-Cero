<a href="category/new" class="btn btn-success mb-4"><i class="fa-solid fa-plus"></i> Crear</a>
        ...
        <?php foreach ($categories as $key => $c): ?>
            <tr>
                ...
                <td>
                    ...
                    <a data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-primary btn-sm m-2 float-right" href="category/edit/<?= $c->category_id ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                </td>
            </tr>
            <?php endforeach?>
        </tbody>
